...
export default function HomePage_Temp_1() {
    ...
    return (
        <>
                    ...
                    <div className="row gx-5 align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="masthead-device-mockup">
                                ...
                                </svg><svg className="shape-2 d-none d-sm-block" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="50"></circle></svg>
                                <div className="device-wrapper">
                                    <div className="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                        <div className="screen bg-black">
                                            <video muted style={{ maxWidth: '100%', height: '100%' }}><source src="/assets/img/demo-screen.mp4" type="video/mp4" /></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <Script src="https://cdn.startbootstrap.com/sb-forms-latest.js" strategy="afterInteractive" />
            <Script src="/template_1/assets/js/scripts.js" strategy="afterInteractive" />
        </>
    );
}
